...
def get_gene_path(ARG, nodes, g1, ref_ARGDB_dict, min_length_dict, group_cov_ratio, max_node_dist, overlap, max_gap_length, max_gap_node, gene_cov):
...
def extract_ARG_paths_seq_gap(g1, ARG_dict, db_fasta, group_cov_ratio, max_node_dist, overlap, max_gap_length, max_gap_node, gene_cov):
    """
    ...
    for ARG, nodes in ARG_dict.items():
        ...
        ARG, paths, additional_info = get_gene_path(ARG, nodes, g1, ref_ARGDB_dict, min_length_dict, group_cov_ratio, max_node_dist, overlap, max_gap_length, max_gap_node, gene_cov)
